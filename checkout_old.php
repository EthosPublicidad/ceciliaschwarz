        ...
        <div class="container">
          <div class="row">
            <div class="col-md-7 col-xs-12">
              <div class="ro-checkout-process">
                <div class="ro-hr-line"><a href="checkout-1.html">
                    <div></div></a><span>Address</span><a href="checkout.html">
                    <div></div></a><span>Payment</span><a href="#">
                    <div></div></a><span>Complet</span></div>
              </div>
              <form class="ro-checkout-information">
                <div class="ro-customer-info">
                  <h4>CUSTOMER INFORMATION</h4>
                  <p><span>Have an account?</span><a href="#">Log in</a></p>
                  <p>Enter your name and email address</p>
                  <div class="ro-account">
                  ...
                  <div class="ro-choice">
                    <label>
                      <input type="radio" name="boolean-0" value="no" checked="checked"/><span>
                        No
                        &nbsp;&nbsp;<i>(You can choose to creat an account later)</i></span>
                    </label><br/>
                    <label>
                      <input type="radio" name="boolean-0" value="yes"/><span>Yes</span>
                    </label>
                  </div>
                ...
                <div class="ro-shipping">
                  ...
                  <div class="ro-button"><a href="checkout.html">CONTINUE</a></div>
                </div>
              </form>
            </div>
            <div class="col-md-5 col-xs-12">
              <div class="ro-checkout-summary">
                ...
                <div class="ro-footer">
                  <div>
                    <p>Subtotal<span><?php echo $subtotales;?></span></p>
                    <div class="ro-divide"></div>
                  </div>
                  <div>
                  ...
                  <div>
                    <p>Total<span><?php echo $subtotales;?></span></p>
                  </div>
                  <div>
                    <p>Payment Due<span><?php echo $subtotales;?></span></p>
                  </div>
                </div>
              </div>
            </div>
